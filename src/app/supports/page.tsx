    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Container padding={5}>
                ...
                <Box mt={5}>
                    <Heading textAlign='center'>Technical support</Heading>
                </Box>
                <PersonalInformation />
                <Center>
                    <Button mt={4} colorScheme='teal' isLoading={isSubmitting} type='submit'>Contact us!</Button>
                </Center>
            </Container>
        </form>
    )
        ...
        return <SimpleGrid columns={[1, 1]} spacing={5}>
            ...
            <Box>
                <FormControl isInvalid={errors.problem !== undefined}>
                    <FormLabel htmlFor='weight'>Your problem/question</FormLabel>
                    <Textarea
                        id={'problem'}
                        {...register('problem')} />
                    {errors.problem && (
